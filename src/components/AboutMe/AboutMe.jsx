    ...
    <section className="aboutMe" id='aboutMe'>
      ...
      <div className="aboutMe__wrapper">
        <div className="aboutMe__info-wrapper">
          ...
          <p className="aboutMe__paragraph">Вырос в Ставропольском крае. После окончания школы поступил в СПбПУ в
            Институт
            металлургии машиностроения и транспорта.После окончания института работал инженером на заводе. По совету
      ...
      <ul className="aboutMe__portfolio-items">
        <li className="aboutMe__portfolio-wrapper">
          <a href="https://igor-yakovlev.github.io/how-to-learn/" target={"_blank"}
        ...
        <li className="aboutMe__portfolio-wrapper">
          <a href="https://igor-yakovlev.github.io/russian-travel/" target={"_blank"}
             className="aboutMe__portfolio-link">
        ...
        <li className="aboutMe__portfolio-wrapper">
          <a href="https://igor.yakovlev.nomorepartiesxyz.ru/sign-in" target={"_blank"}
             className="aboutMe__portfolio-link">
