    ...
    <section className='aboutProject' id='aboutProject'>
      ...
      <div className="aboutProject__wrapper">
        ...
        <div className='aboutProject__item'>
          ...
          <p className="aboutProject__paragraph">У каждого этапа был мягкий и жёсткий дедлайн, которые нужно было
            соблюдать, чтобы успешно защититься.</p>
        </div>
      </div>
      <div className="aboutProject__progress">
        <div className="aboutProject__progress-item" style={{width: '20%'}}>
